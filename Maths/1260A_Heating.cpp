...
void task()
{
    ...
    int per_unit_val = sum / total_num ; 
    int remain = sum % total_num ; 

    int first_half = total_num - remain ;

    print(first_half*(per_unit_val*per_unit_val) + remain*((per_unit_val + 1)*(per_unit_val+1)) , "\n");
